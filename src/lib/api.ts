...
export const api = {
  ...
  listSpriteSheets: (projectId: string, worktreeId?: string) => invoke<SpriteSheet[]>("list_sprite_sheets_safe", { projectId, worktreeId: worktreeId ?? null }),
  queueSpriteSheet: (input: SpriteSheetInput) => invoke<BackgroundJob>("queue_sprite_sheet", { input }),
  deleteSpriteSheet: (id: string) => invoke<void>("delete_sprite_sheet_safe", { id }),
